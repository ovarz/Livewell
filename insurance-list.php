 			  ...
 			  <table class="data_table">
                <thead>
                  <tr>
                    ...
                    <th class="premi">
                      Premi <br />
                      <a class="popup-detail content_center" href="#detail-insurance"><span>?</span></a>
                    </th>
                    <th class="dayrs">
                      Harian Rumah Sakit <br />
                      <a class="popup-detail content_center" href="#detail-insurance"><span>?</span></a>
                    </th>
                    <th class="icuprice">
                      Harga ICU <br />
                    ...
                    <th class="daycrash">
                      Harian Rumah Sakit <br />Karena Kecelakaan <br />
                      <a class="popup-detail content_center" href="#detail-insurance"><span>?</span></a>
                    </th>
                    <th class="surgery">
                      Fedah Pembedahan <br />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="button">
                      <ul>
                        <li class="ins-btn-give-rate"><a class="btn" href="javascript:void(0)"><i class="fa fa-star" aria-hidden="true"></i></a></li>
